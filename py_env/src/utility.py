...
def levenshtein(s, t):
    ...
    Returns:
        Edit distance between arr1 and arr2
    """
    if s == t:
        return 0
    elif len(s) == 0:
...
def convert_melody_to_steps(melody):
    """
    Helper function to convert the melody into steps

    Args:
        melody: Melody list, consisting of Note objects
...
def self_similarity(artifact):
    """
    Self similarity measure of a sequence, by Murray&Ventura 2012.
    It measures how complex the sequence is.
    Related paper: http://axon.cs.byu.edu/papers/murray2012mume
...
def delete_outputs(folder):
    """
    Deletes all contents in the given path, does not remove folder itself
    Args:
        folder: filepath of the folder
    """
...
def sequence_to_stream(sequence):
    ...
    Args:
        sequence: Artifact sequence generated by agents

    Returns:
        Converted sequence to stream.Stream() object
...
def sequence_to_part(sequence):
    """
    Sequence to part conversion

    Args:
        sequence: Artifact sequence generated by agents

    Returns:
        Converted sequence to stream.Part() object
...
def instrument_family(instrument_list, family_name = 'sound_effects'):
    ...
    Args:
        instrument_list: Instrument list genereated by get_instruments method
        family_name: Family name of the instrument
    ...
    Returns:
        Random instrument number by family name
    """
...
def change_instrument(stream, number):
    """
    Changes instrument of the given stream or part

    Args:
        stream: music21 Stream/Part object
        number: Instrument number see the midi-instrument.csv for more detail
    """
